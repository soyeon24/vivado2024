...
HD_PWD='C:/vivadoproject/project_6/project_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_g.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_adder_g.tcl
